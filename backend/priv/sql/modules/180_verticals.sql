...
CREATE TABLE IF NOT EXISTS listing_holiday_home_details (
...
CREATE TABLE IF NOT EXISTS listing_yacht_details (
  listing_id UUID PRIMARY KEY REFERENCES listings (id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS listing_car_rental_details (
  listing_id UUID PRIMARY KEY REFERENCES listings (id) ON DELETE CASCADE,
  vehicle_class TEXT,
  transmission TEXT,
  fuel_type TEXT,
...
CREATE TABLE IF NOT EXISTS listing_transfer_details (
  listing_id UUID PRIMARY KEY REFERENCES listings (id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS listing_hotel_details (
  listing_id UUID PRIMARY KEY REFERENCES listings (id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS listing_flight_details (
  listing_id UUID PRIMARY KEY REFERENCES listings (id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS listing_tour_details (
  listing_id UUID PRIMARY KEY REFERENCES listings (id) ON DELETE CASCADE,
...
CREATE TABLE IF NOT EXISTS listing_activity_details (
  listing_id UUID PRIMARY KEY REFERENCES listings (id) ON DELETE CASCADE,
  session_based BOOLEAN NOT NULL DEFAULT FALSE,
  full_day BOOLEAN NOT NULL DEFAULT FALSE
);

CREATE TABLE IF NOT EXISTS listing_ferry_details (
  listing_id UUID PRIMARY KEY REFERENCES listings (id) ON DELETE CASCADE,
  route_code TEXT,
  timetable_url TEXT
);

CREATE TABLE IF NOT EXISTS listing_visa_details (
  listing_id UUID PRIMARY KEY REFERENCES listings (id) ON DELETE CASCADE,
  destination_country CHAR(2) NOT NULL
);

CREATE TABLE IF NOT EXISTS listing_cinema_details (
  listing_id UUID PRIMARY KEY REFERENCES listings (id) ON DELETE CASCADE,
  cinema_chain TEXT,
  showtimes_json JSONB
);

CREATE TABLE IF NOT EXISTS listing_beach_lounger_details (
  listing_id UUID PRIMARY KEY REFERENCES listings (id) ON DELETE CASCADE,
  beach_name TEXT NOT NULL,
  grid_json JSONB
);

CREATE TABLE IF NOT EXISTS related_listings_rules (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  listing_id UUID NOT NULL REFERENCES listings (id) ON DELETE CASCADE,
