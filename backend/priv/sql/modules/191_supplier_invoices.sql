...
CREATE INDEX idx_supplier_invoices_org ON supplier_invoices (supplier_organization_id, created_at DESC);
...
CREATE INDEX idx_commission_accrual_lines_supplier_invoice
