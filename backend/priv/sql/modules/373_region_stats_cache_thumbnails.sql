-- 373: region-stats cache thumbnail doldur
-- 372 refresh '' yazıyordu → anasayfa “Keşfedilecek bölgeler” gri kutu.
-- Kaynak: location_pages kapakları + bölgedeki bir ilanın featured_image_url.
...
COMMENT ON FUNCTION refresh_listing_region_stats(text) IS
  'listing_region_stats_cache doldurur (cnt + thumbnail); p_category NULL = tüm konaklama kategorileri';
