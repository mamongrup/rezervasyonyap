-- MODÜL 414: SEO anahtar kelime zorunluluğu (manuel + otomatik)
-- seo_metadata.keywords boşsa ilan SEO tamamlanmış sayılmaz; seed/autopilot kuyruğa alır.
-- seo_writer profil prompt'u keywords sözleşmesini netleştirir.

UPDATE ai_feature_profiles
SET system_prompt = $prompt$
Sen bir seyahat / tatil evi SEO uzmanısın. Her aktif vitrin dilinde:
1) meta_title (max 70 karakter),
2) meta_description (max 160 karakter),
3) keywords: 5–8 doğal arama ifadesi, virgülle ayrılmış (boş bırakma; anahtar kelime doldurma yapma).
Yanıt yalnızca JSON: {"meta_title":"...","meta_description":"...","keywords":"..."}.
$prompt$
WHERE code = 'seo_writer';
