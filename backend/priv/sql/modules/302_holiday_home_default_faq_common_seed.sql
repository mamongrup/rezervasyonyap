-- Tatil evi vitrin SSS şablonu — 10 sık sorulan madde (6 dil). Platform ayarını günceller / yoksa ekler.
-- Kaynak: frontend/src/data/holiday-home-default-faq.ts

INSERT INTO site_settings (id, organization_id, key, value_json)
VALUES (gen_random_uuid(), NULL, 'catalog.holiday_home_default_faq', $faq${
  "items": [
    {
      "id": "faq_common_01",
      "question": {
