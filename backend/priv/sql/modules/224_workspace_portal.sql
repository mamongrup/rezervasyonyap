...
CREATE TABLE IF NOT EXISTS staff_workspace_tasks (
...
CREATE INDEX IF NOT EXISTS idx_staff_workspace_tasks_assignee ON staff_workspace_tasks (assignee_user_id);
CREATE INDEX IF NOT EXISTS idx_staff_workspace_tasks_due ON staff_workspace_tasks (due_date);
CREATE INDEX IF NOT EXISTS idx_staff_workspace_tasks_status ON staff_workspace_tasks (status);
CREATE INDEX IF NOT EXISTS idx_staff_workspace_tasks_created ON staff_workspace_tasks (created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_portal_announcements_audience ON portal_announcements (audience, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_portal_announcement_recipients_org ON portal_announcement_recipients (organization_id);
