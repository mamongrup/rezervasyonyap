-- Ön ödeme varsayılanı %30 → %20 (ilan başına `listings.prepayment_percent` ile override edilebilir).

ALTER TABLE listings
  ALTER COLUMN prepayment_percent SET DEFAULT 20;

-- Provizyon / kısmi ödeme hesabında boş ilan alanı için %20 kullan.
...
BEGIN
  SELECT
    ...
    COALESCE(l.prepayment_percent, 20) / 100.0                             AS prepay_rate,
