-- Sürekli SEO/i18n otomasyonu: vitrin gerçeği seo_metadata; eksik ilanları
-- travel-ai-worker her turda yeniden kuyruğa alır (manuel dürtme gerekmez).
-- Autopilot keşfi content_localized_seo yerine seo_metadata kullanır.

-- 1) Eksik çeviri/SEO için akıllı faz seçimli kuyruk besleme
