-- Sosyal paylaşım AI: bölge bilgisini caption üretiminde kullan.
...
3) Platforma uygun paylaşım metni (caption): bölgeyi doğal biçimde kullan; emoji, en fazla 5 hashtag; listing_url metnin sonunda ayrı satırda
