...
fn text_from_response_decoder() -> decode.Decoder(String) {
  decode.field(
    ...
    decode.list(decode.field(
      ...
      decode.field(
        "parts",
        decode.list(decode.field("text", decode.string, fn(t) { decode.success(t) })),
        fn(parts) {
          case parts {
        ...
        json.object([
          #(
            ...
            json.object([
              #(
                "parts",
                json.array(from: [json.object([#("text", json.string(system_prompt))])], of: fn(x) {
                  x
                }),
              ),
            ]),
            ...
            json.array(
              from: [
                json.object([
                  ...
                  #(
                    "parts",
                    json.array(from: [json.object([#("text", json.string(user_msg))])], of: fn(x) {
                      x
                    }),
                  ),
                ]),
