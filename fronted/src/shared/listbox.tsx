      ...
      >
        <Headless.ListboxSelectedOption
          ...
          className={clsx([
            ...
            // Border
            'border border-neutral-950/10 group-data-hover:border-neutral-950/20 group-data-active:border-neutral-950/20 dark:border-white/10 dark:group-data-hover:border-white/20 dark:group-data-active:border-white/20',
            // Background color
