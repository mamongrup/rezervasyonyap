...
const Page = () => {
  ...
  const nextHref = vitrinPath('/add-listing/5')
  ...
  return (
    <>
      <div>
        <h1 className="text-2xl font-semibold">{L.page4.pageTitle}</h1>
        <p className="mt-2 block text-neutral-500 dark:text-neutral-400">
          {L.page4.pageDescription}
        </p>
      </div>
      ...
      <Form id="add-listing-form" action={handleSubmitForm} className="flex flex-col gap-y-12">
        <div>
          <p className="text-lg font-semibold">{L.page4['General amenities']}</p>
        ...
        <div>
          <p className="text-lg font-semibold">{L.page4['Other amenities']}</p>
          <Fieldset className="mt-6">
            <CheckboxGroup className="grid grid-cols-1 gap-4 space-y-0! sm:grid-cols-2 sm:gap-y-6 lg:grid-cols-3">
        ...
        <div>
          <p className="text-lg font-semibold">{L.page4['Safe amenities']}</p>
          <Fieldset className="mt-6">
            <CheckboxGroup className="grid grid-cols-1 gap-4 space-y-0! sm:grid-cols-2 sm:gap-y-6 lg:grid-cols-3">
