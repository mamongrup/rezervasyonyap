import CardCategory7, { type CardCategory7Data } from '@/components/CardCategory7'
...
const MegaMenu = ({ menuItem, category }: { menuItem: TNavigationItem; category: CardCategory7Data }) => {
...
export interface Props {
  ...
  className?: string
  featuredCategory: CardCategory7Data
}
