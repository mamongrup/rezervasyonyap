...
export const BRAVO_TURKISH_ASCII_PAIRS = [
  ...
  ["Alıcıs?", "Alıcısı"],
  ["ALICIS?", "ALICISI"],
  ["konnumlanm??", "konumlanmış"],
  ["Konnumlanm??", "Konumlanmış"],
  ["ihtiya&ccedil;larınızı?", "ihtiya&ccedil;larınızı"],
  ["ihtiyaçlarınızı?", "ihtiyaçlarınızı"],
  ["kar??layacak", "karşılayacak"],
  ["Kar??layacak", "Karşılayacak"],
  ["mutfa??", "mutfağı"],
  ["Mutfa??", "Mutfağı"],
  ["konuklarım?zın", "konuklarımızın"],
  ["Konuklarım?zın", "Konuklarımızın"],
  ["Villa ?im?e?in", "Villa Şimşeğin"],
  ["Villa ?imıeğin", "Villa Şimşeğin"],
  ["Villa ?imşeğin", "Villa Şimşeğin"],
  ["ta? barbek", "taş barbek"],
  ["Ta? barbek", "Taş barbek"],
  ["g?zel", "güzel"],
  ["G?zel", "Güzel"],
  ["G?ZEL", "GÜZEL"],
