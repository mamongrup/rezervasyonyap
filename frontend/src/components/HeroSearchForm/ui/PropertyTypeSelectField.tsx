...
const styles = {
  ...
  panel: {
    base: 'absolute top-full z-[200] mt-3 w-96 transition duration-150 data-closed:translate-y-1 data-closed:opacity-0 left-1/2 -translate-x-1/2 overflow-hidden rounded-3xl bg-white p-7 shadow-lg ring-1 ring-black/5 dark:bg-neutral-800',
    default: '',
    small: '',
  },
}
        ...
        <>
          ...
          >
            {fieldStyle === 'default' && (
              <HugeiconsIcon
                icon={Home01Icon}
                className="size-5 text-neutral-300 lg:size-7 dark:text-neutral-400"
                strokeWidth={1.75}
              />
            )}
