...
const HamburgerBtnMenu = ({ className }: { className?: string } = {}) => {
  ...
  return (
    <button
      ...
      className={
        className ??
        '-m-2.5 flex cursor-pointer touch-manipulation items-center justify-center rounded-full p-2.5 hover:bg-neutral-100 focus-visible:outline-0 dark:hover:bg-neutral-700'
      }
    >
