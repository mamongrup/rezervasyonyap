 ...
 * `contain: strict` / `mix-blend` boyayı kırpar (arama arkası fon yarıda kesilir).
 */
const BgGlassmorphism: FC<BgGlassmorphismProps> = ({
  className = 'absolute inset-x-0 md:top-10 xl:top-40 min-h-0 pl-20 py-24 flex overflow-visible -z-10',
}) => {
  return (
