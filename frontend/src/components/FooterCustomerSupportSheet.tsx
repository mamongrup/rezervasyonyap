...
function CustomerSupportBadge({ className, iconClassName = 'size-7' }: { className?: string; iconClassName?: string }) {
  return (
    <span
      className={clsx(
          ...
          <div className="border-b border-neutral-100 px-5 pt-4 pb-4 dark:border-neutral-800">
            <div className="flex items-center gap-3">
              ...
              <div className="min-w-0">
                ...
                <p className="mt-0.5 text-xs text-neutral-500 dark:text-neutral-400">{bn.supportMenuSubtitle}</p>
              </div>
            </div>
          </div>
...
export function FooterCustomerSupportButton({ onClick, ariaLabel }: { onClick: () => void; ariaLabel: string }) {
  return (
    <button
      type="button"
      onClick={onClick}
