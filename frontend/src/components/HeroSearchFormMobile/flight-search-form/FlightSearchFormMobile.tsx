...
const FlightSearchFormMobile = ({ searchTargetPath: searchTargetPathProp }: Props) => {
  ...
  const handleFormSubmit = (formData: FormData) => {
    ...
    if ((guestInput.guestAdults ?? 0) > 0) qs.set('guestAdults', String(guestInput.guestAdults))
    if ((guestInput.guestChildren ?? 0) > 0) qs.set('guestChildren', String(guestInput.guestChildren))
    if ((guestInput.guestInfants ?? 0) > 0) qs.set('guestInfants', String(guestInput.guestInfants))
    qs.set('trip', tripApi)
