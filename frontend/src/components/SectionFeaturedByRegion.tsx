...
function RegionSlider({ listings, linkBase, priceUnit, nightLabel, locale }: SliderProps) {
  ...
  return (
    <div className="relative">
      ...
      <div className="absolute start-0 top-[40%] z-10 -translate-y-1/2 ltr:-translate-x-1/2 rtl:translate-x-1/2">
      ...
      <div className="absolute end-0 top-[40%] z-10 -translate-y-1/2 ltr:translate-x-1/2 rtl:-translate-x-1/2">
