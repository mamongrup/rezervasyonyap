...
const FooterQuickNavigation = () => {
  ...
  return (
    <>
      ...
      >
        {/* max-w-lg: Chisfis; w-full: dar viewport’ta %100 — taşma yok */}
        <nav
          className="mx-auto grid w-full min-w-0 max-w-full grid-cols-5 items-end justify-items-center gap-x-0 sm:max-w-lg"
          role="navigation"
        >
