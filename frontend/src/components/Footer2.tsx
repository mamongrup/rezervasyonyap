...
export default function Footer2({ locale, branding }: Footer2Props) {
  ...
  const socialItems = [
    ...
    { name: 'Instagram', href: c.socialInstagram, icon: socialIcon('Instagram') },
    { name: 'X', href: c.socialX, icon: socialIcon('X') },
    { name: 'YouTube', href: c.socialYoutube, icon: socialIcon('YouTube') },
  ].filter((x) => x.href)
    ...
    <footer className="min-w-0 overflow-x-clip border-t border-neutral-200 bg-white dark:border-neutral-700 dark:bg-neutral-950">
      ...
      <div className="container min-w-0 pt-16 pb-8 sm:pt-20 sm:pb-10">
        <div className="grid min-w-0 grid-cols-1 gap-12 xl:grid-cols-[minmax(0,280px)_minmax(0,1fr)] xl:gap-14">
          ...
          <div className="grid min-w-0 grid-cols-1 gap-x-8 gap-y-12 sm:grid-cols-2 lg:grid-cols-4">
