...
const FACET_ROUTE_REGISTRY: FacetRouteRegistryEntry[] = [
    ...
    slugs: L(
      {
        ...
        ski: 'kayak-otelleri',
        spa: 'spa-otelleri',
        adults_only: 'yetiskin-otelleri',
        conservative: 'muhafazakar-oteller',
        boutique: 'butik-konsept-oteller',
      },
      {
        ...
        ski: 'ski-hotels',
        spa: 'spa-hotels',
        adults_only: 'adults-only-hotels',
        conservative: 'conservative-hotels',
        boutique: 'boutique-concept-hotels',
      },
      {
        ...
        ski: 'skihotels',
        spa: 'spa-hotels',
        adults_only: 'erwachsenenhotels',
        conservative: 'konservative-hotels',
        boutique: 'boutique-konzept-hotels',
      },
      {
        ...
        ski: 'hotels-ski',
        spa: 'hotels-spa',
        adults_only: 'hotels-adultes',
        conservative: 'hotels-conservateurs',
        boutique: 'hotels-concept-boutique',
      },
    ),
  },
  {
  ...
  // ── Kruvaziyer — gemi hattı + rota ────────────────────────────────────────
  {
    categorySlug: 'kruvaziyer',
    queryKey: 'cruise_line',
    slugs: L(
      {
        msc: 'msc-cruises-turlari',
        costa: 'costa-cruises-turlari',
        'royal-caribbean': 'royal-caribbean-cruises',
        celebrity: 'celebrity-cruises',
        princess: 'princess-cruises-turlari',
        celestyal: 'celestyal-cruises-turlari',
        norwegian: 'norwegian-cruises',
        carnival: 'carnival-cruises',
        oceania: 'oceania-cruises-turlari',
        'selectum-blu': 'selectum-blu-cruises-turlari',
        pullman: 'pullman-cruises',
        miray: 'miray-cruises-turlari',
        aroya: 'aroya-cruises-turlari',
        disney: 'disney-cruise-gemi-turlari',
        amadeus: 'amadeus-river-cruises',
        luxury: 'luxury-cruise-turlari',
      },
      {
        msc: 'msc-cruises',
        costa: 'costa-cruises',
        ...
        'selectum-blu': 'selectum-blu-cruises',
        pullman: 'pullman-cruises',
        miray: 'miray-cruises',
        aroya: 'aroya-cruises',
  ...
  {
    categorySlug: 'kruvaziyer',
    queryKey: 'cruise_route',
    slugs: L(
      {
        'akdeniz-gemi-turlari': 'akdeniz-gemi-turlari',
        'yunan-adalari-gemi-turlari': 'yunan-adalari-gemi-turlari',
        'ege-akdeniz-gemi-turlari': 'ege-akdeniz-gemi-turlari',
        'amerika-gemi-turlari': 'amerika-gemi-turlari',
        'turkiye-cikisli-gemi-turlari': 'turkiye-cikisli-gemi-turlari',
        'vizesiz-gemi-turlari': 'vizesiz-gemi-turlari',
        'baltik-baskentleri-gemi-turlari': 'baltik-baskentleri-gemi-turlari',
        'uzakdogu-gemi-turlari': 'uzakdogu-gemi-turlari',
        'kanarya-adalari-gemi-turlari': 'kanarya-adalari-gemi-turlari',
        'guney-amerika-gemi-turlari': 'guney-amerika-gemi-turlari',
        'misir-gemi-turlari': 'misir-gemi-turlari',
        karayipler: 'karayipler-gemi-turlari',
      },
      {
        'akdeniz-gemi-turlari': 'mediterranean-cruises',
        'yunan-adalari-gemi-turlari': 'greek-islands-cruises',
        'ege-akdeniz-gemi-turlari': 'aegean-mediterranean-cruises',
        'amerika-gemi-turlari': 'americas-cruises',
        'turkiye-cikisli-gemi-turlari': 'cruises-from-turkey',
        'vizesiz-gemi-turlari': 'visa-free-cruises',
        'baltik-baskentleri-gemi-turlari': 'baltic-cruises',
        'uzakdogu-gemi-turlari': 'far-east-cruises',
        'kanarya-adalari-gemi-turlari': 'canary-islands-cruises',
        'guney-amerika-gemi-turlari': 'south-america-cruises',
        'misir-gemi-turlari': 'egypt-cruises',
        karayipler: 'caribbean-cruises',
      },
    ),
  },
]
