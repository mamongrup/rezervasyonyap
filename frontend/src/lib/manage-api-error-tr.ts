...
const TR_BY_CODE: Record<string, string> = {
  ...
  hotel_room_scope_check_failed: 'Oda erişim doğrulaması başarısız. Sayfayı yenileyip tekrar deneyin.',
  hotel_room_not_found: 'Seçili oda bu ilanda bulunamadı.',
  hotel_room_availability_query_failed: 'Oda müsaitlik takvimi okunamadı.',
  hotel_room_availability_upsert_failed: 'Oda müsaitliği kaydedilemedi.',
  hotel_room_availability_transaction_failed: 'Oda müsaitliği kaydı tamamlanamadı.',
  ...
  media_cdn_all_401: 'CDN ayarları için oturum gerekli; yeniden giriş yapın.',
  image_profiles_401: 'Görsel profil ayarları için oturum gerekli; yeniden giriş yapın.',
  missing_token: 'Oturum bulunamadı; yeniden giriş yapın.',
  ...
  social_jobs_clear_500: 'Sosyal kuyruk temizlenemedi.',
  jobs_clear_failed: 'Sosyal kuyruk temizleme işlemi başarısız oldu.',
  job_insert_failed:
