...
const SEARCH_INDEX = [
  ...
  { label: 'Otel detay kampanyaları', href: '/manage/catalog/hotel/valid-campaigns', tag: 'katalog' },
  ...
  { label: 'Yapay Zeka Ayarları (Gemini & DeepSeek)', href: '/manage/admin/settings?tab=ai', tag: 'yapay zeka' },
  { label: 'AI İlan İçerik & SEO', href: '/manage/ai/listing-content', tag: 'yapay zeka' },
  ...
  { label: 'AI SEO Oluşturucu', href: '/manage/ai/seo', tag: 'yapay zeka' },
  { label: 'AI Satış Chatbotu', href: '/manage/ai/chatbot', tag: 'yapay zeka' },
  { label: 'AI Çeviri Asistanı', href: '/manage/ai/translate', tag: 'yapay zeka' },
  { label: 'AI Kontrol Merkezi', href: '/manage/ai/control-center', tag: 'yapay zeka' },
  { label: 'AI Onay Kuyruğu', href: '/manage/ai/approvals', tag: 'yapay zeka' },
  { label: 'AI İş Kuyruğu', href: '/manage/admin/marketing/ai', tag: 'yapay zeka' },
  { label: 'SEO Genel', href: '/manage/seo', tag: 'seo' },
  { label: 'SEO Ayarları (Site)', href: '/manage/admin/settings?tab=seo', tag: 'seo' },
  ...
  { label: 'Genel Site Ayarları', href: '/manage/admin/settings', tag: 'ayarlar' },
  { label: 'Site Kimliği & Logo', href: '/manage/admin/settings?tab=kimlik', tag: 'ayarlar' },
  { label: 'Google Servisleri & Doğrulama', href: '/manage/admin/settings?tab=google', tag: 'ayarlar' },
