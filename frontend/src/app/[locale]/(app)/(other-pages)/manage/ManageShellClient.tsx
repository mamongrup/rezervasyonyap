...
export default function ManageShellClient({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="manage-shell flex min-h-[calc(100dvh-5rem)] items-start bg-[color:var(--manage-page-bg)] text-[color:var(--manage-text)] transition-colors duration-200">
      ...
      <aside
        className={[
          'fixed left-0 z-50 flex w-[min(100%,16.5rem)] shrink-0 flex-col border-r border-[color:var(--manage-sidebar-border)] pb-safe shadow-lg backdrop-blur-xl transition-transform duration-200 ease-out lg:sticky lg:top-0 lg:z-20 lg:h-auto lg:w-64 lg:min-w-64 lg:max-w-64 lg:flex-none lg:translate-x-0 lg:pb-0 lg:shadow-none',
