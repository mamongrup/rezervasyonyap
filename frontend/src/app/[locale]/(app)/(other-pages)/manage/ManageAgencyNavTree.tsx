...
const GROUPS: NavGroupDef[] = [
  {
    ...
    items: [
      { path: '/manage/agency', label: 'Acente özeti' },
      { path: '/manage/agency/announcements', label: 'Yönetici duyuruları' },
      { path: '/manage/agency/profile', label: 'Acente profili' },
    ],
  },
  {
    id: 'sales',
    label: 'Satış & Rezervasyon',
    Icon: ShoppingCart,
    items: [
      { path: '/manage/agency/sales', label: 'Satış ekranı (POS)' },
      { path: '/manage/agency/reservations', label: 'Tüm rezervasyonlar' },
      { path: '/manage/agency/calendar', label: 'Takvim görünümü' },
      { path: '/manage/agency/offers', label: 'Teklifler' },
    ],
  },
  {
    id: 'finance',
    ...
    Icon: CreditCard,
    items: [
      { path: '/manage/agency/invoices', label: 'Faturalar' },
      { path: '/manage/agency/commissions', label: 'Komisyon takibi' },
      { path: '/manage/agency/wallet', label: 'Cüzdan & bakiye' },
    ],
  },
  {
    id: 'campaigns',
    ...
    Icon: Megaphone,
    items: [
      { path: '/manage/agency/campaigns', label: 'Kampanyalar & kuponlar' },
      { path: '/manage/agency/packages', label: 'Paket tatil oluştur' },
    ],
  },
  {
    id: 'api',
    ...
    Icon: Code2,
    items: [
      { path: '/manage/agency/api-keys', label: 'API anahtarları' },
      { path: '/manage/agency/webhooks', label: 'Webhook ayarları' },
      { path: '/manage/agency/ical', label: 'iCal senkronu' },
    ],
  },
  {
    id: 'verification',
    label: 'TÜRSAB Doğrulama',
    Icon: BadgeCheck,
    items: [
      { path: '/manage/agency', label: 'Belge durumu & başvuru' },
    ],
  },
  {
    id: 'settings',
    ...
    Icon: Settings,
    items: [
      { path: '/manage/agency/settings', label: 'Hesap ayarları' },
      { path: '/manage/agency/notifications', label: 'Bildirim tercihleri' },
      { path: '/manage/agency/team', label: 'Ekip üyeleri' },
    ],
  },
]
...
export default function ManageAgencyNavTree({
  onNavLinkClick,
}: {
  onNavLinkClick?: () => void
}) {
