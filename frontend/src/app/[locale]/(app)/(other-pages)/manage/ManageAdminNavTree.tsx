...
const GROUPS: NavGroupDef[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { path: '/manage/finance/currencies', label: 'Para birimleri & kurlar' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { path: '/manage/admin/marketing/ai', label: 'AI iş kuyruğu' },
        ],
      },
      {
        heading: 'SEO yönetimi',
        items: [
          { path: '/manage/admin/settings?tab=seo', label: 'Genel SEO ayarları' },
          { path: '/manage/seo', label: 'SEO paneli' },
          ...
          { path: '/manage/seo/rich-snippets', label: 'Zengin sonuçlar (Schema)' },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { path: '/manage/admin/settings?tab=kimlik', label: 'Site kimliği & logo' },
          { path: '/manage/admin/settings?tab=operasyon', label: 'Ödeme & para birimleri' },
          { path: '/manage/admin/settings?tab=google', label: 'Google & Analitik' },
          ...
          { path: '/manage/settings/maps', label: 'Google Maps ayarları' },
      ...
      },
      {
        ...
        items: [
          ...
          { path: '/manage/notifications/sms', label: 'SMS bildirimleri (Netgsm)' },
