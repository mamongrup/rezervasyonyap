...
export default function CatalogNewListingClient({
  ...
  /** Kısa konaklama eşiği = `minStayNights` (tek alan; ayrı min gece yok). */
    ...
    void (async () => {
      try {
        ...
        if (basics) {
          ...
          // Tek kaynak: listings.min_stay_nights; eski çift alanı (meta) yalnız boşsa yedekle
        ...
        if (meta) {
          ...
          // Eski çift «min gece» alanından yedek: temel min boşsa meta eşiğini kullan
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Kısa konaklama eşiği = Temel Bilgiler'deki tek «Min. konaklama» alanı
      metaBody.min_short_stay_nights = minStayNights.trim()
      ...
      {hasPhysicalRegion ? (
        <div className="mb-4 space-y-3 rounded-xl border border-neutral-200 p-4 dark:border-neutral-700">
          <p className="text-sm font-medium text-neutral-800 dark:text-neutral-200">
            Vitrin konumu (arama ve kart satırı)
          </p>
          ...
          <div className="w-full space-y-5">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <Field className="block">
                      ...
                      />
                      <HintText>
                        Takvim ve kısa konaklama ücreti bu değere bağlıdır. Boş bırakılırsa minimum gece kısıtı yok.
                      </HintText>
                    </Field>
                  </div>
                </div>
                ...
                <Section title="Fiyatlandırma">
                  ...
                  <div className="mt-8 border-t border-neutral-100 pt-6 dark:border-neutral-700">
                    ...
                    <p className="mt-0.5 text-xs text-neutral-500 dark:text-neutral-400">
                      Temel Bilgiler’deki min. konaklama gecesinin altında kalınırsa (ör. boşluk doldurma)
                      bu tutar bir kez alınır.
                      {minStayNights.trim()
                        ? ` Şu an eşik: ${minStayNights.trim()} gece.`
                        : ' Önce Temel Bilgiler’de min. konaklama girin.'}
                    </p>
                    <Field className="mt-4 block max-w-md">
                      ...
                      />
                      <HintText>
                        Boş bırakılırsa ücret yoktur. Eşik tek <strong>Min. konaklama</strong> alanından gelir.
                      </HintText>
                    </Field>
                  </div>
            ...
            <AgencyQualityChecklist
              listing={{
                ...
                hasAttributes: Object.keys(attributeValues).length > 0 || (isHotel && (hotelAgencyState.amenities?.length ?? 0) > 0) || (isYacht && (yachtAgencyState.water_sports?.length ?? 0) > 0),
                hasPricing: Boolean(basePrice.trim() || rules.length > 0 || calRows.length > 0),
