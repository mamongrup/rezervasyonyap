...
export const SUBCATEGORY_REGISTRY: SubcategoryEntry[] = [
  ...
  { id: 'tour-cultural',     slug: 'kultur-turlari',    parentCategorySlug: 'turlar', name: 'Kültür Turları',   nameEn: 'Cultural Tours',     emoji: '🏛️', color: 'amber',   order: 3, enabled: true, description: 'Tarihi ve kültürel keşifler', descriptionEn: 'Historical and cultural discoveries', href: '/turlar/kultur-turlari' },
  { id: 'tour-kultur-kapadokya', slug: 'kapadokya-turlari', parentCategorySlug: 'turlar', name: 'Kapadokya Turları', nameEn: 'Cappadocia Tours', emoji: '🎈', color: 'rose', order: 31, enabled: true, description: 'Peri bacaları ve balon turları', descriptionEn: 'Fairy chimneys and balloon tours', href: '/turlar/all?tour_region=kapadokya' },
  { id: 'tour-kultur-karadeniz', slug: 'karadeniz-turlari', parentCategorySlug: 'turlar', name: 'Karadeniz Turları', nameEn: 'Black Sea Tours', emoji: '🌲', color: 'green', order: 32, enabled: true, description: 'Yeşil doğa ve yayla rotaları', descriptionEn: 'Green highlands and coastal routes', href: '/turlar/all?tour_region=karadeniz' },
  { id: 'tour-kultur-gap', slug: 'gap-turlari', parentCategorySlug: 'turlar', name: 'GAP Turları', nameEn: 'GAP Tours', emoji: '🏜️', color: 'orange', order: 33, enabled: true, description: 'Güneydoğu Anadolu keşfi', descriptionEn: 'Southeast Anatolia discovery', href: '/turlar/all?tour_region=gap' },
  { id: 'tour-kultur-ege', slug: 'ege-akdeniz-turlari', parentCategorySlug: 'turlar', name: 'Akdeniz-Ege Turları', nameEn: 'Aegean & Mediterranean', emoji: '🏖️', color: 'cyan', order: 34, enabled: true, description: 'Ege ve Akdeniz kıyıları', descriptionEn: 'Aegean and Mediterranean coasts', href: '/turlar/all?tour_region=ege-akdeniz' },
  { id: 'tour-kultur-ic', slug: 'ic-anadolu-turlari', parentCategorySlug: 'turlar', name: 'İç Anadolu Turları', nameEn: 'Central Anatolia', emoji: '🕌', color: 'amber', order: 35, enabled: true, description: 'Ankara, Konya ve çevresi', descriptionEn: 'Ankara, Konya and surroundings', href: '/turlar/all?tour_region=ic-anadolu' },
  { id: 'tour-kultur-dogu', slug: 'dogu-anadolu-turlari', parentCategorySlug: 'turlar', name: 'Doğu Anadolu Turları', nameEn: 'Eastern Anatolia', emoji: '🏔️', color: 'stone', order: 36, enabled: true, description: 'Doğu Anadolu kültür rotaları', descriptionEn: 'Eastern Anatolia cultural routes', href: '/turlar/all?tour_region=dogu-anadolu' },
  { id: 'tour-kultur-gunubirlik', slug: 'gunubirlik-turlar', parentCategorySlug: 'turlar', name: 'Günübirlik Turlar', nameEn: 'Day Tours', emoji: '🚌', color: 'sky', order: 37, enabled: true, description: 'Konaklamasız kısa turlar', descriptionEn: 'Short tours without overnight stay', href: '/turlar/all?tour_region=gunubirlik' },
  { id: 'tour-kultur-marmara', slug: 'marmara-turlari', parentCategorySlug: 'turlar', name: 'Marmara Turları', nameEn: 'Marmara Region', emoji: '🌉', color: 'indigo', order: 38, enabled: true, description: 'İstanbul çevresi ve Marmara', descriptionEn: 'Istanbul area and Marmara', href: '/turlar/all?tour_region=marmara' },
