...
CREATE TEMP TABLE tmp_loc_fixes (
...
INSERT INTO tmp_loc_fixes (ref, location_name, district, city, province, address, lat, lng) VALUES
...
CREATE TEMP TABLE tmp_loc_targets ON COMMIT DROP AS
SELECT l.id AS listing_id, f.*
FROM tmp_loc_fixes f
JOIN listings l
